...
trait TestFixtures {
  ...
  trait Matches extends Listings with Products {
    ...
    val expectedJsonAsString =
      """{"product_name":"Sony_Cyber-shot_DSC-W310","listings":[{"title":"Sony Cybershot DSC-W310","manufacturer":"Sony"""" +
      ""","currency":"USD","price":"100.00"},{"title":"New Cybershot DSC-W310 Sony","manufacturer":"Sony","currency":""" +
      """"CAD","price":"130.11"}]}""" + "\n" + """{"product_name":"Samsung_TL240","listings":[{"title":"Genuine """ +
      """Samsung EB575152VU i9000 GalaxyS Battery","manufacturer":"Samsung","currency":"CAD","price":"13.99"}]}"""
